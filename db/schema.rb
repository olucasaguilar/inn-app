...
ActiveRecord::Schema[7.0].define(version: 2023_11_28_200412) do
  ...
  create_table "guest_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_guest_users_on_user_id"
  end
  ...
  create_table "reservation_additionals", force: :cascade do |t|
    t.datetime "datetime_check_in"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "reservation_id", null: false
    t.datetime "datetime_check_out"
    t.integer "payment_method_id"
    t.index ["payment_method_id"], name: "index_reservation_additionals_on_payment_method_id"
    t.index ["reservation_id"], name: "index_reservation_additionals_on_reservation_id"
  end
  ...
  add_foreign_key "reservation_additionals", "payment_methods"
  add_foreign_key "reservation_additionals", "reservations"
